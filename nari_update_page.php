...
$query = "SELECT * FROM nari_bachat where id =$i";
$result = mysqli_query($con,$query)or die(mysqli_error($con));
$arr=mysqli_fetch_array($result,MYSQLI_ASSOC);
?>
<div class="about-sec-ab">
    <h1 align="center">edit this data?</h1>
    <form method="POST" action="core/nari_update_process.php" class="add-admin">
  ...
  <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label">  After Maturity:</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="maturity" name="maturity" value="<?php echo $arr['maturity']?>">
    </div>
  </div>
