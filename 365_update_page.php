...
$query = "SELECT * FROM days_365 where id =$i";
$result = mysqli_query($con,$query)or die(mysqli_error($con));
$arr=mysqli_fetch_array($result,MYSQLI_ASSOC);
?>
<div class="about-sec-ab">
    <h1 align="center">edit this data?</h1>
    <form method="POST" action="core/365_update_process.php" class="add-admin">
    <div class="login-user"><input type="hidden" name="id" value="<?php echo $arr['id']?>"></div><br>
  <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label">Daily:</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="daily" name="daily" value="<?php echo $arr['daily']?>">
    </div>
  </div>
  <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label"> 365 Days:</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="all_day" name="all_day" value="<?php echo $arr['all_day']?>">
    </div>
  </div>
  <div class="row mb-3">
