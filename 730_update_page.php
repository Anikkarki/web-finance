...
$query = "SELECT * FROM days_730 where id =$i";
$result = mysqli_query($con,$query)or die(mysqli_error($con));
$arr=mysqli_fetch_array($result,MYSQLI_ASSOC);
?>
<div class="about-sec-ab">
    <h1 align="center">edit this data?</h1>
    <form method="POST" action="core/730_update_process.php" class="add-admin">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="all_days" name="all_days" value="<?php echo $arr['all_days']?>">
    </div>
  </div>
  <div class="row mb-3">
