...
<html>
    <head>
        <title>Kopila Saving Scheme</title>
...
<body>
    ...
    <br><br>
    <u><h2 align=center>Kopila Saving</h2></u>
...
$query = "SELECT * FROM kopila_bachat";
...
while ($arr = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
    ...
    <tr>
      ...
      <?php echo "&nbsp;<td><a href='kopila_update_page.php?id=".$arr['id']."'>EDIT</a>"; }?>
  </tr>
